...
function SideBarL() {
  return (
    <>
      <a href="/home">
        <div className="div-container p-2 rounded-pill mt-2" id="home-icon">
      ...
      <a href="/home">
        <div className="div-container p-2 rounded-pill">
          ...
          <div className="centered px-3 fs-2 d-none d-md-block align-items-center">
      ...
      <a href="#" className="">
        <div className="div-container p-2 rounded-pill">
          ...
          <div className="centered px-3 fs-2 d-none d-md-block">
      ...
      <a href="/<%= postUser.username %> " className="">
        <div className="div-container p-2 rounded-pill">
          <div className="icon-container">
            <svg viewBox="0 0 24 24" aria-hidden="true" className="logo">
              <g>
      ...
      <div className="centered px-3 fs-2">
        <button className="btn rounded-pill btn-tweet py-2">
          <span>Tweet</span>
        </button>
      </div>
    </>
