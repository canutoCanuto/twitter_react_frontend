...
function SideBarL() {
  ...
  return (
    <div className="sidebar-left-container sticky-top  ">
      ...
      <Link to={`/users/${sessionData.username}`} className="">
        <div className="div-container px-2 pt-1 rounded-pill">
          <div className="icon-container">
            <svg
              viewBox="0 0 24 24"
      ...
      <div className="centered px-1 fs-2 bottonTweeet">
        <button
          className="btn rounded-pill btn-tweet py-2 me-3"
          onClick={handleShow}
        >
          <span className="d-none d-md-block">Tweet</span>
          <svg viewBox="0 0 24 24" className="d-md-none ">
            <g>
